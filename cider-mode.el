...
(defconst cider-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "C-c l a a") #'cider-log-appender-add)
    (define-key map (kbd "C-c l a c") #'cider-log-appender-clear)
    (define-key map (kbd "C-c l a k") #'cider-log-appender-kill)
    (define-key map (kbd "C-c l a u") #'cider-log-appender-update)
    (define-key map (kbd "C-c l c a") #'cider-log-consumer-add)
    (define-key map (kbd "C-c l c k") #'cider-log-consumer-kill)
    (define-key map (kbd "C-c l c u") #'cider-log-consumer-update)
    (define-key map (kbd "C-c l e c") #'cider-log-event-clear-buffer)
    (define-key map (kbd "C-c l e e") #'cider-log-event-show-stacktrace)
    (define-key map (kbd "C-c l e i") #'cider-log-event-inspect)
    (define-key map (kbd "C-c l e p") #'cider-log-event-pretty-print)
    (define-key map (kbd "C-c l e s") #'cider-log-event-search)
    (define-key map (kbd "C-c l f b") #'cider-log-set-buffer)
    (define-key map (kbd "C-c l f j") #'cider-log-framework-browse-javadoc)
    (define-key map (kbd "C-c l f s") #'cider-log-set-framework)
    (define-key map (kbd "C-c l f w") #'cider-log-framework-browse-website)
