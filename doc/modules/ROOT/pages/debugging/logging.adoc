...
- Open exceptions attached to log events in the link:debugger.html[Debugger]
...
image::cider-appender.png[CIDER Log Consumer]
...
image::cider-consumer.png[CIDER Log Consumer]
...
image::cider-event.png[CIDER Log Event]
